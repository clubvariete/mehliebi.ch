<template>
  <div>
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <a class="flex justify-center pt-8 sm:pt-0" href="https://v3.nuxtjs.org" target="_blank">
        <!-- Nuxt Logo -->
